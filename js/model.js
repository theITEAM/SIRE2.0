function modelbuts()                                                                                 // Draws the model page
{
	...
	addbutton("Include polygenetic variation in traits?",x+25,y+3,500,0,-1,SUBTEXTBUT,-1,-1)
	addbutton("Yes",xx+30,y,70,15,RADIOBUT,RADIOBUT,1,RADIORAND);
	addbutton("No",xx+100,y,70,15,RADIOBUT,RADIOBUT,0,RADIORAND);
	y += dy;
